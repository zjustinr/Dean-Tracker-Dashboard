...
// request body -- otherwise anyone who guesses a client name could overwrite
// (or fabricate) another client's mirrored candidate list. Same HMAC verify
// as api/data.js / api/trial.js.
...
module.exports = async function handler(req, res) {
  ...
  const c = trustedClient(req);
  if (!c) { res.status(200).json({ ok: true, logged: false }); return; }
