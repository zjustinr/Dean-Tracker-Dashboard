...
export const SPEC = {
  ...
  usadvancement: ["r1-advancement-deans.json", null, null, false],
};

// The visible switcher list (excludes hidden top100), for the corpus tally.
export const VISIBLE = ["r1bschool", "r1eschool", "r1university", "r1medical", "r1law", "r1provost", "usag", "usnursing", "uspharmacy", "useducation", "r1arts", "uspublichealth", "usvet", "usr2", "ussystem", "usgrad", "uscreativearts", "usadvancement"];

// Global enrichment maps served straight through (no assembly).
export const ENRICHMENT = new Set(["dean-photos.json", "leader-research.json", "leader-careers.json", "affinity-by-school.json"]);
