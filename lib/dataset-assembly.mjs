...
export const VISIBLE = ["r1bschool", "r1eschool", "r1university", "r1medical", "r1law", "r1provost", "usag", "usnursing", "uspharmacy", "useducation", "r1arts", "uspublichealth", "usvet", "usr2"];
